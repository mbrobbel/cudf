...
mod tests {
    ...
    fn sum_i32() {
        ...
        let result = col.view().sum(TypeId::INT32).unwrap();
    ...
    fn min_i32() {
        ...
        let result = col.view().min(TypeId::INT32).unwrap();
    ...
    fn max_f64() {
        ...
        let result = col.view().max(TypeId::FLOAT64).unwrap();
    ...
    fn product_i32() {
        ...
        let result = col.view().product(TypeId::INT32).unwrap();
    ...
    fn any_bool_true() {
        ...
        let result = col.view().any().unwrap();
    ...
    fn all_bool_true() {
        let col = Column::from_scalar(&ScalarVal::from_bool(true), 3);
        let result = col.view().all().unwrap();
        assert_eq!(result.as_bool(), Some(true));
    }
